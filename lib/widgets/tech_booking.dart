...
class TechBookingItem extends StatefulWidget{
  @override
  State<TechBookingItem> createState() => _TechBookingItemState();
}

class _TechBookingItemState extends State<TechBookingItem> {
